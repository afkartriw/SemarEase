...
import LoginDialog from "@/app/components/Mahasiswa/LoginDialog"; // Impor komponen CalendarDialog
        ...
        <div className="flex space-x-4 mb-6 px-8">
          <div className="flex-grow">
            <div className="relative w-full h-full">
              {" "}
              {/* Kontainer dengan tinggi tertentu */}
              <Image
                src="/images/rr1.png" // Ganti dengan URL gambar yang sesuai
                alt="Ruangan Aula FEB"
                layout="fill" // Membuat gambar mengisi kontainer
                objectFit="cover" // Menjaga rasio gambar sambil mengisi kontainer
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="relative">
              <Image
                ...
                className="rounded-lg object-cover"
              />
              <div className="rounded-lg absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center text-white font-bold text-lg cursor-pointer">
                Lihat Semua Foto
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mx-10">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="border p-4 rounded-lg">
              ...
              <ul className="list-decimal ml-6 text-gray-700 space-y-2">
                <li>
                  Peminjam wajib menjaga kebersihan dan ketertiban ruangan
                  selama dan setelah penggunaan.
                </li>
                <li>
                  Kerusakan pada fasilitas ruangan akan menjadi tanggung jawab
                  peminjam.
                </li>
                <li>
                  Kegiatan harus bersifat akademik, sosial, atau budaya yang
                  mendukung tujuan kampus.
                </li>
                <li>
                  Peminjam harus mengembalikan ruangan dalam kondisi semula
                  setelah selesai digunakan.
                </li>
                <li>
                  Dilarang membawa barang-barang berbahaya atau melakukan
          ...
          <div className="flex flex-col ">
            ...
            <div className="flex justify-center">
              <LoginDialog /> {/* Panggil komponen CalendarDialog */}
            </div>
            {/* <div className="flex justify-center">
              <a
                href="/peminjaman"
