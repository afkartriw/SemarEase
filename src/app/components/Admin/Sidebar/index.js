    ...
    <div className="w-72 h-screen bg-white text-black p-5 fixed top-0 left-0 z-10 flex flex-col shadow-md">
      ...
      <div className="flex-grow flex flex-col mt-20">
        <ul>
          ...
          <li className={`border-t border-gray-400 ${pathname === "/admin/ruangan" ? "bg-blue-100" : ""}`}>
            <Link
              href="/admin/ruangan"
              className={`flex items-center space-x-4 hover:bg-blue-300 p-3 rounded text-black ${pathname === "/admin/ruangan" ? "bg-blue-300" : ""}`}
            >
              <span>Ruangan</span>
            </Link>
          </li>
          <li className={`border-t border-gray-400 ${pathname === "/admin/pesan" ? "bg-blue-100" : ""}`}>
            <Link
              href="/admin/pesan"
              className={`flex items-center space-x-4 hover:bg-blue-300 p-3 rounded text-black ${pathname === "/admin/pesan" ? "bg-blue-300" : ""}`}
            >
              <span>Pesan</span>
            </Link>
          </li>
          ...
          <li className={`border-b border-gray-400 ${pathname === "/admin/history" ? "bg-blue-100" : ""}`}>
            <Link
              href="/admin/history"
              className={`flex items-center space-x-4 hover:bg-blue-300 p-3 rounded text-black ${pathname === "/admin/history" ? "bg-blue-300" : ""}`}
            >
              <span>History</span>
            </Link>
          </li>
